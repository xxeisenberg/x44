/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: f34a680bf8d45d4d08045c33b7de910f)
// Runtime types generated with workerd@1.20260702.1 2026-06-14 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BUCKET: R2Bucket;
	DB: D1Database;
	QUEUE: Queue;
	FRONTEND_URL: "https://x44.diy";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FRONTEND_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_API_KEY" | "BETTER_AUTH_IDENTIFY_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_WEBHOOK_SECRET" | "WORKER_URL" | "BUILD_WORKER_URL" | "BUILD_WORKER_SECRET">> {}
}
